...
if ( 'post' === $post_type ) {
	...
	$title_and_editor .= '<p>' . __( 'Visual mode gives you an editor that is similar to a work processor. Click the Toolbar Toggle button to get a second row of controls.' ) . '</p>';
