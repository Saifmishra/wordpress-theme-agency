...
function wptexturize( $text, $reset = false ) {
	...
	if ( $reset || ! isset( $static_characters ) ) {
		...
		// Apostrophe in a work. No spaces, double apostrophes, or other punctuation.
		if ( "'" !== $apos ) {
...
function shortcode_unautop( $pee ) {
	...
	$pattern =
		...
		.     '(?![\\w-])'                   // Not followed by work character or hyphen.
 ...
 *
 * The 55 work limit can be modified by plugins/themes using the {@see 'excerpt_length'} filter
