 ...
 * @property {RegExp}              connectorRegExp                   Regular expression that matches work connectors, like em-dash
...
/**
 * Lower-level settings for work counting that can be overridden.
 *
 ...
 * ```
 *
 * @return {number} The work or character count.
 */
