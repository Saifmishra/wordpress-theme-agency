...
class getid3_ac3 extends getid3_handler
{
	...
	public function Analyze() {
		...
		// end of each frame is an error check field that includes a CRC work for error detection. An
		// additional CRC work is located in the SI header, the use of which, by a decoder, is optional.
		//
		...
		if ($thisfile_ac3_raw_bsi['bsid'] <= 8) {
			...
			if ($thisfile_ac3_raw_bsi['frmsizecod'] > 37) { // binary: 100101 - see Table 5.18 Frame Size Code Table (1 work = 16 bits)
	...
	public static function frameSizeLookup($frmsizecod, $fscod) {
		...
		$paddingBytes = 0;
		if (($fscod == 1) && $padding) {
			// frame lengths are padded by 1 work (16 bits) at 44100
