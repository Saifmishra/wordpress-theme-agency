...
class Text_Diff_Renderer_inline extends Text_Diff_Renderer {
    ...
    /**
     * What are we currently splitting on? Used to recurse to show work-level
    ...
    function _changed($orig, $final)
    {
        ...
        if ($this->_split_characters) {
            ...
            /* We want to split on work boundaries, but we need to preserve
    ...
    function _splitOnWords($string, $newlineEscape = "\n")
    {
        ...
        while ($pos < $length) {
            // Eat a work with any preceding whitespace.
