...
function wp_default_scripts( $scripts ) {
	...
	$scripts->add( 'work-count', "/wp-admin/js/work-count$suffix.js", array(), false, 1 );
	...
	if ( is_admin() ) {
		...
		$scripts->add( 'post', "/wp-admin/js/post$suffix.js", array( 'suggest', 'wp-lists', 'postbox', 'tags-box', 'underscore', 'work-count', 'wp-a11y', 'wp-sanitize', 'clipboard' ), false, 1 );
...
function wp_just_in_time_script_localization() {
	...
	wp_localize_script(
		...
		array(
			/*
			 * translators: If your work count is based on single characters (e.g. East Asian characters),
